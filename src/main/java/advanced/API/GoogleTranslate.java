...
public final class GoogleTranslate {
     ...
     */
    public static String translateVietnameseToEnglish(String vietnameseText) throws IOException {
        return translate("vi", "en", vietnameseText);
    }

    /**
     * english to vietnamese.
     */
    public static String translateEnglishToVietnamese(String englishText) throws IOException {
        return translate("en", "vi", englishText);
    }
    ...
    public static class Main {
        public static void main(String[] args) {
            try {
                ...
                String vietnameseText = "tôi là bạn";
                String translatedToEnglish = GoogleTranslate.translateVietnameseToEnglish(vietnameseText);
                System.out.println("Vietnamese to English: " + translatedToEnglish);

                // Test translation from English to Vietnamese
                String englishText = "Hello";
                String translatedToVietnamese = GoogleTranslate.translateEnglishToVietnamese(englishText);
                System.out.println("English to Vietnamese: " + translatedToVietnamese);
